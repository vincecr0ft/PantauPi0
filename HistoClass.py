...
class ListoHistos(object):
    def __init__(self,name):
        ...
        self.h_reco1P1N_true1P1N=TH1F('h_reco1P1N_true1P1N_'+name,'Correctly identified 1p1n taus',40,-2.,2.)
        ...
        self.h_reco1P0N_true1P0N=TH1F('h_reco1P0N_true1P0N_'+name,'Reco 1P0N true 1P1N',40,-2.,2.)
        self.h_reco1P0N_true1P1N=TH1F('h_reco1P0N_true1P1N_'+name,'Correctly identified 1p0n taus',40,-2.,2.)
        ...
        self.h_dR=TH1F('h_dR_'+name,'dR between reco and true',40,0.,0.4)
